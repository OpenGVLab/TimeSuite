...
class VideoChat2_it4_mistral_LinearP(Blip2Base):
    """
    VideoChat2 model.
    """
    ...
    def get_clip_time_instruct(self,text_input):
        ...
        for text in text_input:
            ...
            for i in range(self.clip_num):
                ...
                #     time_instru = f" The video contains {self.clip_frames} frames without timestamps. "
                # else:
                #     time_instru = f" The video contains {self.clip_frames} frames sampled at {', '.join(sec[i*self.clip_frames:(i+1)*self.clip_frames])} seconds. "
    ...
    def encode_long_video(self, image, text_input, instruction):            
        ...
        # print("time_instructions: ", time_instructions)
        # print("\n\n")
        with self.maybe_autocast():
